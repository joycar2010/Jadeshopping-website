...
const Help: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      category: 'payment',
      question: '支持哪些支付方式？',
      answer: '我们支持多种支付方式：微信支付、支付宝、银联卡支付、网银支付。对于高价值商品，还支持银行转账和分期付款服务。所有支付过程均采用SSL加密技术，确保您的资金安全。'
    },
    {
      category: 'payment',
      question: '支付失败怎么办？',
      answer: '如遇支付失败，请检查：1）网络连接是否正常；2）银行卡余额是否充足；3）支付限额是否超出。如问题仍未解决，请联系客服或尝试其他支付方式。'
    },
    {
      category: 'shipping',
      question: '配送范围和时间？',
